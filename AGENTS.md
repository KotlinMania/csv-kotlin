...
This file is the quick-reference operating contract for csv-kotlin. The longer
...
csv-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`csv`](https://crates.io/crates/csv). Upstream Rust is the behavioral oracle while the
