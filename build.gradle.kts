...
kotlin {
    ...
    swiftExport {
        moduleName = "Csv"
        flattenPackage = "io.github.kotlinmania.csv"
    }

    android {
        namespace = "io.github.kotlinmania.csv"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "csv-kotlin", version.toString())

    pom {
        name.set("csv-kotlin")
        description.set("Kotlin Multiplatform port of BurntSushi/rust-csv - Fast CSV parsing with support for serde")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/csv-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/csv-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/csv-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/csv-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.csv.codeql
